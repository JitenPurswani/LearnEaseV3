...
model_path = "C:\\MProj\\LearnEase\\backend\\mcq_t5_finetuned1"  # Update with your model path
...
# Example paragraph
paragraph = "Biodiversity is the variety of life on Earth. It plays a crucial role in maintaining the balance of natural systems. High biodiversity ensures ecosystem resilience, enabling environments to withstand climate fluctuations, natural disasters, and human impacts. Many industries, including agriculture, pharmaceuticals, and tourism, rely on diverse biological resources. Efforts to conserve natural habitats, reduce pollution, and combat climate change are crucial steps toward preserving the rich tapestry of life on Earth. Protecting and promoting biodiversity should be a global priority, ensuring that future generations inherit a vibrant and sustainable world."

# Generate 10 MCQs
print("Generating 10 MCQs from the paragraph...")
mcqs = generate_multiple_mcqs(paragraph, num_questions=10)
